...
#ifdef __SYMBIAN32__
EXPORT_C GType ** _g_param_spec_types()
{
...
g_param_spec_types_init (void)	
{
 ...
 /* G_TYPE_PARAM_ENUM
   ...
   */
  {
    ...
    #else 
    GParamSpecTypeInfo pspec_info;
    pspec_info.instance_size = sizeof (GParamSpecGType); 
    pspec_info.n_preallocs = 0;
    pspec_info.instance_init = param_gtype_init;
    pspec_info.value_type = G_TYPE_GTYPE;
    pspec_info.finalize = NULL;
    pspec_info.value_set_default = param_gtype_set_default;
    pspec_info.value_validate = param_gtype_validate;
    pspec_info.values_cmp = param_gtype_values_cmp;
    #endif /* __SYMBIAN32__ */
