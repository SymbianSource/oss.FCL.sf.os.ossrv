...
PLS(g_io_watch_funcs,giounix,GSourceFuncs)
#define g_io_watch_funcs  (*FUNCTION_NAME(g_io_watch_funcs,giounix)())

const GSourceFuncs temp_g_io_watch_funcs = {
  g_io_unix_prepare,
  g_io_unix_check,
  g_io_unix_dispatch,
  g_io_unix_finalize
...
#ifdef __SYMBIAN32__
EXPORT_C GSourceFuncs *_g_io_watch_funcs()
{
	return &g_io_watch_funcs;
}
#endif /* __SYMBIAN32__ */

#if EMULATOR

PLS(unix_channel_funcs,giounix,GIOFuncs )
#define unix_channel_funcs (*FUNCTION_NAME(unix_channel_funcs,giounix)())

const GIOFuncs temp_unix_channel_funcs = {
  g_io_unix_read,
  g_io_unix_write,
  g_io_unix_seek,
  g_io_unix_close,
