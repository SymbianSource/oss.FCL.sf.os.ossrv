...
public:
    ...
    BOOST_STATIC_CONSTANT(float_denorm_style, has_denorm = static_cast<std::float_denorm_style>(limits_type::has_denorm));
    ...
    BOOST_STATIC_CONSTANT(float_round_style, round_style = static_cast<std::float_round_style>(limits_type::round_style));
