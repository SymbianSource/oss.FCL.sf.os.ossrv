...
PLS(quark,g_convert_error_quark,GQuark)
#define quark (*FUNCTION_NAME(quark,g_convert_error_quark)())
	 ...
	 gsize   *outbytes_left)
{
  ...
  return iconv (cd, FIX_CASTING(const char **)inbuf, inbytes_left, outbuf, outbytes_left);
}
...
PLS(cache_private,g_get_filename_charsets,GStaticPrivate)
#define cache_private (*FUNCTION_NAME(cache_private,g_get_filename_charsets)())
