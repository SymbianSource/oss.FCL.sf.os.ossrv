...
#define G_MALLOC_VOID(numbytes , var) { \
	if(numbytes) \
	{ \
		var = g_try_malloc(numbytes); \
		if(!var) \
			return; \
	} \
	else\
...
#ifdef __SYMBIAN32__
EXPORT_C const  guint *_glib_major_version()
{
	return &glib_major_version;
}
EXPORT_C const  guint *_glib_minor_version()
{
	return &glib_minor_version;
}
EXPORT_C const  guint *_glib_micro_version()
{
	return &glib_micro_version;
}
EXPORT_C const  guint *_glib_interface_age()
{
	return &glib_interface_age;
}
EXPORT_C const  guint *_glib_binary_age()
{
...
#ifdef __SYMBIAN32__
  return getProgPath((char *)program);
#endif /* __SYMBIAN32__ */
...
g_path_is_absolute (const gchar *file_name)
{
  ...
  #ifdef __SYMBIAN32__
  /* Recognize drive letter on __SYMBIAN32__ */
...
PLS(max_len,g_get_current_dir ,gulong)
#define max_len (*FUNCTION_NAME(max_len,g_get_current_dir )())
...
PLS_MACRO(g_utils_global,gutils,GStaticMutex)
PLS(g_tmp_dir,gutils,gchar *)
PLS(g_user_name,gutils,gchar *)
PLS(g_real_name,gutils,gchar *)
PLS(g_home_dir,gutils,gchar *)
PLS(g_host_name,gutils,gchar *)

#define g__g_utils_global_lock (*FUNCTION_NAME_MACRO(g_utils_global,gutils)())
#define g_tmp_dir (*FUNCTION_NAME(g_tmp_dir,gutils)())
#define g_user_name (*FUNCTION_NAME(g_user_name,gutils)())
#define g_real_name (*FUNCTION_NAME(g_real_name,gutils)())
#define g_home_dir (*FUNCTION_NAME(g_home_dir,gutils)())
#define g_host_name (*FUNCTION_NAME(g_host_name,gutils)())
...
PLS(g_user_data_dir ,gutils,gchar *)
PLS(g_system_data_dirs,gutils,gchar **)
PLS(g_user_cache_dir,gutils,gchar *)
PLS(g_user_config_dir,gutils,gchar *)
PLS(g_system_config_dirs,gutils,gchar **)

#define g_user_data_dir  (*FUNCTION_NAME(g_user_data_dir ,gutils)())
#define g_system_data_dirs (*FUNCTION_NAME(g_system_data_dirs,gutils)())
#define g_user_cache_dir (*FUNCTION_NAME(g_user_cache_dir,gutils)())
#define g_user_config_dir (*FUNCTION_NAME(g_user_config_dir,gutils)())
#define g_system_config_dirs (*FUNCTION_NAME(g_system_config_dirs,gutils)())
...
PLS_MACRO(g_prgname,gutils,GStaticMutex)
PLS(g_prgname,gutils,gchar *)

#define g__g_prgname_lock (*FUNCTION_NAME_MACRO(g_prgname,gutils)())
#define g_prgname (*FUNCTION_NAME(g_prgname,gutils)())
...
PLS_MACRO(g_application_name ,gutils,GStaticMutex)
PLS(g_application_name ,gutils,gchar *)

#define g__g_application_name_lock (*FUNCTION_NAME_MACRO(g_application_name,gutils)())
#define g_application_name  (*FUNCTION_NAME(g_application_name ,gutils)())
 ...
 * Since: 2.6
 **/
EXPORT_C G_CONST_RETURN gchar * G_CONST_RETURN * 
...
#elif defined(__SYMBIAN32__)
	  gchar *data_dirs = applicationpath();
...
PLS(alias_table ,gutils,GHashTable *)
#define alias_table  (*FUNCTION_NAME(alias_table ,gutils)())
...
PLS(said_before ,unalias_lang,gboolean)
#define said_before  (*FUNCTION_NAME(said_before ,unalias_lang)())
...
PLS(cache_private ,g_get_language_names ,GStaticPrivate)
#define cache_private  (*FUNCTION_NAME(cache_private ,g_get_language_names )())
...
#include <libintl.h>    //puneetpuneet
...
PLS(_glib_gettext_initialized,_glib_gettext,gboolean)
#define _glib_gettext_initialized (*FUNCTION_NAME(_glib_gettext_initialized,_glib_gettext)())
...
#if EMULATOR
#undef _glib_gettext_initialized
#endif /* EMULATOR */
