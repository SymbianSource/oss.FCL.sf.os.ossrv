...
PLS(_g_debug_initialized ,gmessages,gboolean)
PLS(_g_debug_flags,gmessages,guint)
#define _g_debug_initialized (*FUNCTION_NAME(_g_debug_initialized,gmessages)())
#define _g_debug_flags (*FUNCTION_NAME(_g_debug_flags,gmessages)())
...
PLS(g_messages_lock,gmessages,GMutex *)
PLS(g_log_domains,gmessages,GLogDomain *)
PLS(g_log_always_fatal,gmessages,GLogLevelFlags)
PLS(glib_print_func,gmessages,GPrintFunc)
PLS(glib_printerr_func,gmessages,GPrintFunc)
PLS(g_log_depth,gmessages,GPrivate *)
PLS(g_log_msg_prefix,gmessages,GLogLevelFlags)
PLS(default_log_func,gmessages,GLogFunc)
PLS(default_log_data,gmessages,gpointer)


#define g_messages_lock (*FUNCTION_NAME(g_messages_lock,gmessages)())
#define g_log_domains (*FUNCTION_NAME(g_log_domains,gmessages)())
#define g_log_always_fatal (*FUNCTION_NAME(g_log_always_fatal,gmessages)())
#define glib_print_func (*FUNCTION_NAME(glib_print_func,gmessages)())
#define glib_printerr_func (*FUNCTION_NAME(glib_printerr_func,gmessages)())
#define g_log_depth (*FUNCTION_NAME(g_log_depth,gmessages)())
#define g_log_msg_prefix (*FUNCTION_NAME(g_log_msg_prefix,gmessages)())
#define default_log_func (*FUNCTION_NAME(default_log_func,gmessages)())
#define default_log_data (*FUNCTION_NAME(default_log_data,gmessages)())
...
PLS(initialized ,g_messages_prefixed_init,gboolean)
#define initialized  (*FUNCTION_NAME(initialized ,g_messages_prefixed_init)())
...
PLS(handler_id,g_log_set_handler,guint)
#define handler_id (*FUNCTION_NAME(handler_id,g_log_set_handler)())
...
PLS(warned,strdup_convert,gboolean)
#define warned (*FUNCTION_NAME(warned,strdup_convert)())
...
#ifdef __SYMBIAN32__
EXPORT_C gboolean * __g_debug_initialized()
{
	return &_g_debug_initialized;
}

EXPORT_C guint * __g_debug_flags()
{
	return &_g_debug_flags;
}
#endif /* __SYMBIAN32__ */
