...
PLS(parent_class ,gtypemodule,gpointer)
#define parent_class  (*FUNCTION_NAME(parent_class,gtypemodule)())
...
PLS(type_module_type,g_type_module_get_type ,GType)
#define type_module_type (*FUNCTION_NAME(type_module_type,g_type_module_get_type )())
