...
PLS(glib_on_error_halt,gbacktrace,volatile gboolean)
#define glib_on_error_halt  (*FUNCTION_NAME(glib_on_error_halt ,gbacktrace)())
...
#ifdef __SYMBIAN32__
EXPORT_C volatile gboolean *_glib_on_error_halt()
{
	return &glib_on_error_halt;
}
#endif /* __SYMBIAN32__ */
...
{
#if (defined(G_OS_UNIX) || defined(G_OS_BEOS)) && !defined(__SYMBIAN32__)
  pid_t pid;
  gchar buf[16];
